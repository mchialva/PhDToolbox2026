# Final Workshop
This is a practice-oriented course and you won't need to take any exams. However, beside completing the few homeworks we assigned [here](https://github.com/mchialva/PhDToolbox2026/tree/main/docs/Exercises/signed here to Please complete the following exercises and load your final outputs in the opened Moodle tasks [here](moodle link) to show you acquired knowledge we ask you to develop your own real project and to showcase it to your peers and teachers during the last Workshop session that will be held on February 2, 09:00-12:00.
